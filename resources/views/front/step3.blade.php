					...
					<form method="POST" action="{{ route('auth.step4') }}" name = "form">
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="text" name="name" class="input-text" value="{{ old('name') }}" style="width:302px" maxlength='10' required /></td>
								@error('name')
							...
							<tr>
								...
								<td><input type="text" name="user_id" class="input-text @error('user_id') is-invalid @enderror" value="{{ old('user_id') }}" style="width:302px" placeholder="영문자로 시작하는 4~15자의 영문소문자, 숫자" maxlength='15' required /><a href="#" class="btn-s-tin ml10">중복확인</a></td>
								@error('user_id')
									<div class="alert alert-danger">{{ $message }}</div>
								@enderror
							</tr>
							...
							<tr>
								...
								<td><input type="password" name="password_confirmation" class="input-text" style="width:302px" maxlength='15'/></td>
							</tr>
							<tr>
								<th scope="col"><span class="icons">*</span>이메일주소</th>
								<td>
									<input type="hidden" name ="email" id="emailid"/>
									<input type="text" name="email1" value="{{ old('email1') }}" class="input-text" id ="email1" style="width:138px" maxlength='15' required/> @ 
									<input type="text" name="domain" value="{{ old('domain') }}" id="domain" class="input-text" style="width:138px" maxlength='15' required/>
							...
							<tr>
								...
								<td>
									...
									<input type="text" class="input-text" name ="phone1" id="phone1" value="{{ old('phone1') }}" style="width:50px" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength='3' required/> - 
									<input type="text" class="input-text" name ="phone2" id="phone2" value="{{ old('phone2') }}" style="width:50px" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength='4' required/> - 
									<input type="text" class="input-text" name ="phone3" id="phone3" value="{{ old('phone3') }}" style="width:50px" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength='4' required/>
								</td>
								@error('phone')
									<div class="alert alert-danger">{{ $message }}</div>
								@enderror
							...
							<tr>
								...
								<td>
									...
									<input type="text" class="input-text" name="tel1" id ="tel1" value="{{ old('tel1') }}" style="width:88px" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength='4' /> - 
									<input type="text" class="input-text" name="tel2" id ="tel2" value="{{ old('tel2') }}" style="width:88px" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength='4'/> - 
									<input type="text" class="input-text" name="tel3" id ="tel3" value="{{ old('tel3') }}" style="width:88px" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength='4'/>
								</td>
							</tr>
							<tr>
								...
								<td>
									<p>
										<label>우편번호 <input type="text" class="input-text ml5" name="addr1" value="{{ old('addr1') }}" style="width:242px" maxlength='15' required /></label><a href="#" class="btn-s-tin ml10" >주소찾기</a>
									</p>
									<p class="mt10">
										<label>기본주소 <input type="text" class="input-text ml5" name="addr2" value="{{ old('addr2') }}" style="width:719px" maxlength='30' required /></label>
									</p>
									<p class="mt10">
										<label>상세주소 <input type="text" class="input-text ml5" name="addr3" value="{{ old('addr3') }}" style="width:719px" maxlength='30' required /></label>
									</p>
								</td>
							</tr>
							<tr>
