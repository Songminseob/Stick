	...
	<div id="content" class="content">
		...
		<table border="0" cellpadding="0" cellspacing="0" class="tbl-col">
			...
			<tbody>
				...
				<tr>
					<th scope="col">제목</th>
					<td><input type="text" class="input-text" style="width:611px" name = "title" value="{{ $post->title }}" required/></td>
				</tr>
				<tr>
...
<script>
	$(document).ready(function(){
		...
		$("#btn-s").click(function(){
			...
			star = $("input[name='allstar']:checked").val();
