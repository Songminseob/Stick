...
<div class="login-section">
	...
	<div class="login-inner">
			...
			<div class="box-login">
				<div class="login-input">
					<div class="input-text-box">
						<input type="text" class="input-text mb5" name = "user_id" placeholder="아이디" style="width:190px"/>
				...
				<div class="login-chk">
					<label class="input-sp">
						<input type="checkbox"/>
						<span class="input-txt" name ="remember">아이디 저장</span>
					</label>
		...
		<span class="login-close"><button type="button" class="icon-layer-close" onclick="location.href='/'"><span class="hidden">닫기</span></button></span>	
	</div>
	</form>
